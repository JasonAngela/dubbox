...
<head>
    ...
    <style type="text/css">
        * {
        ...
        .com_report_table table {
            border: none;
            border-spacing: 10px;
            border-collapse: separate;
        }

        .com_report_table thead,
        .com_report_table tbody {
            border: none;
        }

        .com_report_table thead td,
        .com_report_table thead th {
        ...
        .com_report_table tr>td:last-of-type {
            border-right: 1px solid #c2c2c2;
        }

        .com_report_table tbody td {
            padding: 0 10px;
        }
    </style>
</head>
